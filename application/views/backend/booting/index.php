<div class="">
	<div class="page-title">
		<div class="title_left">
			<h3>Solui & Pertanyaan Kerusakan Booting/h3>
		</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
				<a href="<?php echo site_url('booting/tambah_pertanyaan');?>" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a>
						...
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<tr class="even pointer">
									...
									<td><a href="<?php echo site_url('booting/edit/'.$row->id_pertanyaan);?>"><i class="glyphicon glyphicon-edit"></i></a>
										|
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-6 col-xs-6">
			<div class="x_panel">
				...
				<div class="x_content">
				<a href="<?php echo site_url('booting/tambah_solusi');?>" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i></a>
					<div class="table-responsive">
						...
						<table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<tr class="even pointer">
									<td><?php echo $row->id_pertanyaan;?></td>
									<td><?php echo $row->pertanyaan;?></td>
									<td><a href="<?php echo site_url('booting/edit_solusi/'.$row->id_pertanyaan);?>"><i class="glyphicon glyphicon-edit"></i></a>
									| 
...
<script>
	$(function(){
		...
		$("#konfirmasi").click(function(){
			...
			$.ajax({
				url:"<?php echo site_url('booting/hapus');?>",
				type:"POST",
				data:"kode="+kode,
				cache:false,
				success:function(html){
					location.href="<?php echo site_url('booting/index/delete_success_pertanyaan');?>";
				}
			});
		});
		...
		$("#konfirmasi").click(function(){
			...
			$.ajax({
				...
				cache:false,
				success:function(html){
					location.href="<?php echo site_url('booting/index/delete_success_solusi');?>";
				}
			});
		});
	});
